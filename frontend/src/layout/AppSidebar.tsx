...
// Icons (adjust to match your actual imports)
import {
  ChevronDownIcon,
  HorizontaLDots,
  UserCircleIcon,
...
const AppSidebar: React.FC = () => {
  ...
  // Detect if a submenu should be open based on the current route
  useEffect(() => {
  ...
  // Dynamically set submenu height for smooth open/close animations
  useEffect(() => {
    if (openSubmenu !== null) {
  ...
  // Handle toggling a submenu open/closed
  ...
  return (
    ...
    >
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              ...
              <img
                ...
                src="/images/logo/bridge_logo_dark.png"
                alt="Logo"
                width={240}
                height={60}
              />
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        ...
        {/* Sidebar widget or extra content */}
